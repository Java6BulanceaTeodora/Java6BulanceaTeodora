...
public class TestEBooksStore {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            statement.execute("CREATE TABLE EBOOKS (ISBN VARCHAR (50) PRIMARY KEY, DENUMIRE VARCHAR (50), TYPE VARCHAR (25) , PAGES INTEGER, GENRE VARCHAR (25),PRICE DECIMAL (5,2))");
            statement.execute("CREATE TABLE BOOK_AUTHORS (CNP VARCHAR (13) PRIMARY KEY,FIRST_NAME VARCHAR (30),FAMILY_NAME VARCHAR (30))");
            statement.execute("CREATE TABLE EBOOKS_AUTHORS(ID INTEGER PRIMARY KEY, ISBN VARCHAR (50), CNP VARCHAR(13))");
            ...
            statement.execute("CREATE TABLE USERS (CNP VARCHAR (13) PRIMARY KEY,NAME VARCHAR (50), PASSWORD VARCHAR (50), ROLE VARCHAR (25))");
            statement.execute("CREATE TABLE EBOOKS_RATINGS_USERS(ID INTEGER PRIMARY KEY,RATING VARCHAR (5), CNP VARCHAR (13), ISBN VARCHAR (50))");
            ...
            statement.execute("CREATE TABLE ORDERS (ORDER_NO INTEGER PRIMARY KEY, ISBN VARCHAR (50), CNP VARCHAR (13), ID_DOWNLOAD INTEGER,ID_PAYMENT INTEGER, ORDER_DATE DATE)");
