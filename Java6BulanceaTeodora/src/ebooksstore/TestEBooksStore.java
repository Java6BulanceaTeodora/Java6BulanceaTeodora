...
public class TestEBooksStore {
    ...
    public static void main(String[] args) {
	    ...
	    //			 FOREIGN KEY (CNP) REFERENCES BOOK_AUTHORS (CNP) )");
            ...
            //statement.execute("CREATE TABLE USERS (CNP VARCHAR (13) PRIMARY KEY,
	    //			NAME VARCHAR (50), PASSWORD VARCHAR (50), ROLE VARCHAR (25),
            //                  FOREIGN KEY (ROLE) REFERENCES USERS_ROLES (ROLE))");
            //statement.execute("CREATE TABLE EBOOKS_RATINGS_USERS(ID INTEGER PRIMARY KEY,
	    //				RATING VARCHAR (5), CNP VARCHAR (13), ISBN VARCHAR (50),
	    ...
	    //				FOREIGN KEY (ISBN) REFERENCES EBOOKS (ISBN))");
            ...
            //statement.execute("CREATE TABLE ORDERS (ORDER_NO INTEGER PRIMARY KEY, ISBN VARCHAR (50), 
	    //		CNP VARCHAR (13), ID_DOWNLOAD INTEGER,
	    //		ID_PAYMENT INTEGER, ORDER_DATE DATE,
	    //		FOREIGN KEY (ISBN) REFERENCES EBOOKS (ISBN),
	    //		FOREIGN KEY (CNP) REFERENCES USERS (CNP),
	    //		FOREIGN KEY (ID_DOWNLOAD) REFERENCES DOWNLOADS (ID_DOWNLOAD),
